...
<body>
  ...
  <div id="echelle" class="echelle">
    <div id="PresentationCategories">
      ...
      <p>Vous retrouverez ici l’échelle des VIP et l’importance (relative*) de chaque catégorie !
        Vous pourrez ainsi facilement repérer les stars ou futures stars du tennis pour finalement venir à leur rencontre et éviter les hasbeens de l’évènement ! </p>
    </div>
  ...
  <h3> Master </h3>
  <hr class="sousH3">
    <p>Les personnes aux portes de la gloire ! Elles sont très souvent connues du grand public, influentes et possèdent une solide notoriété. Incontournables pour les personnes s’intéressant au tennis. </p>
  </div>
  <div class="CategoriesVIP">
  <h3> Star </h3>
  <hr class="sousH3">
  ...
  <h3> Maestro </h3>
  <hr class="sousH3">
    <p>Seule une minorité de connaisseurs de tennis les connaisse ! Futures « craques » de ce sport, entraineurs ambitieux ou encore futurs grands influenceurs, ne les perdez pas de vues ! Ce seront peut-être un jour de futurs pivots de ce sport !</p>
  </div>
  <div class="CategoriesVIP">
  <h3> Hasbeen </h3>
  <hr class="sousH3">
    <p>Les personnes à se méfier de cet évènement ! Personnes en quête de grandeur ou bien anciennes stars cherchant à regagner leur notoriété d’antan… Il vaut mieux les éviter. Elles ont tendance à attirer l’attention du public par tous les moyens. </p>
  </div>
  <div class="CategoriesVIP">
  <h3> Rookie </h3>
  <hr class="sousH3">
  ...
  <h3> Unknown </h3>
  <hr class="sousH3">
    <p>Personnes totalement inconnues. Débutants ou personnes n’ayant jamais décollé ? Vous pouvez en croiser tous les jours mais peut-être que parmi ces personnes se cache la future star de demain !</p>
  </div>
</div>
  </div>

  <div class="remarque">
    *Cette échelle a pour but de divertir, elle n’est pas à prendre au sérieux
  </div>
